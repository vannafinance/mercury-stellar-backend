...
// =====================================================================
// Network + Contract Addresses — Read from .env.local
// =====================================================================
// Source of truth: `.env.example` (committed) + `.env.local` (gitignored).
// Hardcoded fallbacks below are testnet defaults — used only if an env
// var is missing, so the app still boots in stale dev environments.
// Refreshed: 2026-04-28 by vanna_deployer (GAUVY7FNDKVWRMW3SYEMX6QMFSWQDKC6XIPJJKAMOEMLZPAI7XZPDV3D)
// =====================================================================
...
export const CONTRACT_ADDRESSES = {
  // Core Infrastructure
  REGISTRY: env('NEXT_PUBLIC_REGISTRY_ADDR', 'CC35XWCH7SCQROTNW7PA6HZKP4JMNSVV2K7CX3HY2PSI2MI2ZQQH73ID'),
  ORACLE: env('NEXT_PUBLIC_ORACLE_CONTRACT', 'CB72D6SOUHUTCESXYOQOBMP6MRSH47NBYIBH73BBRH3ZRT53LPTB6R7V'),
  RATE_MODEL: env('NEXT_PUBLIC_RATE_MODEL_ADDR', 'CCJAUPCU6EIFQK6GTAAYLW3Y4YETJAAUPAGBPFGQ2OUJPSW3WWHUCL2Z'),
  RISK_ENGINE: env('NEXT_PUBLIC_RISK_ENGINE_ADDR', 'CDPHBVIRQ2SEFMKPUM4ZOGPERBKPY3NRDJ2XK3JCLN5C63VTBZ22TFFU'),

  // vToken Contracts (admin = corresponding lending pool)
  VXLM_TOKEN: env('NEXT_PUBLIC_VXLM_TOKEN', 'CA43UX5EXSYGO7GALIMAZHFOQJKQREEBSOMQKXFY4Q53W2WT3Q766KCU'),
  // USDC-based vTokens for the 4 pools (LENDING_PROTOCOL_USDC === LENDING_PROTOCOL_BLEND_USDC, so they share one vToken)
  VUSDC_TOKEN: env('NEXT_PUBLIC_VUSDC_TOKEN', 'CALPGNHCBAIVBNFHN4JA7LD5MWP3EUPUKKQYPSVWRTISCN56RUVEOR2S'),
  VBLEND_USDC_TOKEN: env('NEXT_PUBLIC_VBLEND_USDC_TOKEN', 'CALPGNHCBAIVBNFHN4JA7LD5MWP3EUPUKKQYPSVWRTISCN56RUVEOR2S'),
  VAQUARIUS_USDC_TOKEN: env('NEXT_PUBLIC_VAQUARIUS_USDC_TOKEN', 'CABIJXHKS7APMBX3HAKELEYBJJM5JC2MOTEKBXZ7USMITFSIUQRHQMVF'),
  VSOROSWAP_USDC_TOKEN: env('NEXT_PUBLIC_VSOROSWAP_USDC_TOKEN', 'CC3XG2J24HM3FVZ6WGHADCQ2CEXIU3OWBQJMYEVUYGV6G7C5JTSUDKR3'),
  VEURC_TOKEN: env('NEXT_PUBLIC_VEURC_TOKEN', 'CC7DTPGZP6A47OK4GXSP6MU2MJUVTUDMBREZN3BEAGNBB6XK3UKFJ7YP'),

  // Lending Protocols (4 main pools for frontend)
  LENDING_PROTOCOL_XLM: env('NEXT_PUBLIC_LENDING_POOL_XLM', 'CAQWQ652YXHA7YKFQBGW2JQAVS4B4HA7WMUGAYIRZGS2CJ3LQ34XUZBA'),
  LENDING_PROTOCOL_USDC: env('NEXT_PUBLIC_LENDING_POOL_USDC', 'CB6NGO7ZCGWRMAVL7RYYRK2I63MSAWMC5Y3EHT5TMNLBAJPD6FWBNT2E'),
  LENDING_PROTOCOL_BLEND_USDC: env('NEXT_PUBLIC_LENDING_POOL_BLEND_USDC', 'CB6NGO7ZCGWRMAVL7RYYRK2I63MSAWMC5Y3EHT5TMNLBAJPD6FWBNT2E'),
  LENDING_PROTOCOL_AQUARIUS_USDC: env('NEXT_PUBLIC_LENDING_POOL_AQUARIUS_USDC', 'CDFIKHQUPTEGQO35DWBHH4RLJ62QA6BRDLNBXA2HBRTHY4OD2MJC3EXU'),
  LENDING_PROTOCOL_SOROSWAP_USDC: env('NEXT_PUBLIC_LENDING_POOL_SOROSWAP_USDC', 'CAHB2PPE5PMJN7R2HAHBVO6C2NMA2BB4JAIQIJSJTIJYGA32QSGLYN6V'),
  LENDING_PROTOCOL_EURC: env('NEXT_PUBLIC_LENDING_POOL_EURC', 'CBAO22UBE7QRVTG3XX6H5TG33YKFM6ZKHIY4IRDD33ADY2WRJBQ4LIAB'),

  ACCOUNT_MANAGER: env('NEXT_PUBLIC_ACCOUNT_MANAGER_ADDR', 'CCKJOXCBCCZ54CWNMDXSX3WMMP4AYMJGVBN3HPSJLQA4Z5WCBMA7CSP7'),
  SMART_ACCOUNT_TEMPLATE: env('NEXT_PUBLIC_SMART_ACCOUNT_TEMPLATE', 'CDD7DEIRLFP36WCU7IHH3ACGBXM7QW3IBTYTRYXM3PV2NFGOKZI3XFWL'),
  // Tracks per-margin-account Blend b-token positions (BLEND_XLM, BLEND_USDC)
  TRACKING_TOKEN: env('NEXT_PUBLIC_TRACKING_TOKEN', 'CBDCPYKNSQYY46PQPXBKLSERJQYG5A6D3MIHUMYPENOFK6NGOZENJEG5'),

  // ── Blend Capital Testnet (https://github.com/blend-capital/blend-utils) ──
  BLEND_POOL: env('NEXT_PUBLIC_BLEND_POOL', 'CCEBVDYM32YNYCVNRXQKDFFPISJJCV557CDZEIRBEE4NCV4KHPQ44HGF'),
  BLEND_BACKSTOP: env('NEXT_PUBLIC_BLEND_BACKSTOP', 'CBDVWXT433PRVTUNM56C3JREF3HIZHRBA64NB2C3B2UNCKIS65ZYCLZA'),
  BLEND_EMITTER: env('NEXT_PUBLIC_BLEND_EMITTER', 'CC3WJVJINN4E3LPMNTWKK7LQZLYDQMZHZA7EZGXATPHHBPKNZRIO3KZ6'),
  BLEND_TOKEN: env('NEXT_PUBLIC_BLEND_TOKEN', 'CB22KRA3YZVCNCQI64JQ5WE7UY2VAV7WFLK6A2JN3HEX56T2EDAFO7QF'),
  BLEND_XLM: env('NEXT_PUBLIC_BLEND_XLM', 'CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC'),
  BLEND_USDC: env('NEXT_PUBLIC_BLEND_USDC', 'CAQCFVLOBK5GIULPNZRGATJJMIZL5BSP7X5YJVMGCPTUEPFM4AVSRCJU'),

  // ── Aquarius AMM Testnet ──
  AQUARIUS_ROUTER: env('NEXT_PUBLIC_AQUARIUS_ROUTER', 'CBCFTQSPDBAIZ6R6PJQKSQWKNKWH2QIV3I4J72SHWBIK3ADRRAM5A6GD'),
  AQUARIUS_XLM_USDC_POOL: env('NEXT_PUBLIC_AQUARIUS_XLM_USDC_POOL', 'CD3LFMMLBQ6RBJUD3Z2LFDFE6544WDRMWHEZYPI5YDVESYRSO2TT32BX'),
  AQUARIUS_USDC: env('NEXT_PUBLIC_AQUARIUS_USDC', 'CAZRY5GSFBFXD7H6GAFBA5YGYQTDXU4QKWKMYFWBAZFUCURN3WKX6LF5'),
  // Pool index (BytesN<32>) for the XLM/USDC pool — found via router.get_pools()
  AQUARIUS_POOL_INDEX_HEX: env('NEXT_PUBLIC_AQUARIUS_POOL_INDEX_HEX', '9ac7a9cde23ac2ada11105eeaa42e43c2ea8332ca0aa8f41f58d7160274d718e'),
  AQUARIUS_XLM_AQUA_POOL: env('NEXT_PUBLIC_AQUARIUS_XLM_AQUA_POOL', 'CCSXYUVLYALKJGIIYMGYLZI447VS6TDWFTVDL43B4IKK2WERHLWUVCRC'),
  AQUARIUS_XLM_USDT_POOL: env('NEXT_PUBLIC_AQUARIUS_XLM_USDT_POOL', 'CA6DAGOMK5D7GKBNWVCIEAYSTPJXLQUFWFKSZOMNEM6BVOTUBDCTIT5I'),

  // ── Soroswap DEX Testnet (https://github.com/soroswap/core/blob/main/public/testnet.contracts.json) ──
  SOROSWAP_ROUTER: env('NEXT_PUBLIC_SOROSWAP_ROUTER', 'CCJUD55AG6W5HAI5LRVNKAE5WDP5XGZBUDS5WNTIVDU7O264UZZE7BRD'),
  SOROSWAP_FACTORY: env('NEXT_PUBLIC_SOROSWAP_FACTORY', 'CDP3HMUH6SMS3S7NPGNDJLULCOXXEPSHY4JKUKMBNQMATHDHWXRRJTBY'),
  SOROSWAP_XLM: env('NEXT_PUBLIC_SOROSWAP_XLM', 'CDLZFC3SYJYDZT7K67VZ75HPJVIEUVNIXF47ZG2FB2RMQQVU2HHGCYSC'),
  SOROSWAP_USDC: env('NEXT_PUBLIC_SOROSWAP_USDC', 'CB3TLW74NBIOT3BUWOZ3TUM6RFDF6A4GVIRUQRQZABG5KPOUL4JJOV2F'),
  SOROSWAP_XLM_USDC_POOL: env('NEXT_PUBLIC_SOROSWAP_XLM_USDC_POOL', 'CDVAIOYHCD4RUSLQNVFI7RIZBFT2JZMJWM4RTOLQZQXL4QAVXU5RFKDB'),
};
