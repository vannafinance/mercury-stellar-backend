...
// Redeployed 2026-07-09 (fresh deploy_all — Vatsal's Blend/Aquarius/Soroswap budget
// optimization patch merged in; the previous long-lived contracts hit a mysterious
// Error(WasmVm, InvalidAction) trap on plain borrow() traced to accumulated pool/
// registry state, not a code bug — confirmed by this fresh deploy working cleanly.
// See Protocol_V1_Soroban CONTRACT_COMMAND.md §21/§22.)
export const CONTRACT_ADDRESSES = {
  // Core
  REGISTRY: 'CD4QEON7FKSP5XVA6DXNFNU4XVOY7QO6N4YCHK6VP3UUM7WS2BMMQ3PU',
  ORACLE: 'CCKVP3BLVZDMTBLESYHJ3ZCLPJDBQVF4UWCSZRVAWBOPKWXGZFF7MTKR',
  RATE_MODEL: 'CCIVR6ZHID2OUTX32NYXBXNIFVBHNUGRUN26F5VOYHUTVHOIYLAD5IUI',
  RISK_ENGINE: 'CAYY5LGQSL6T6LJ6CBZBV7MBW5PZFQTC3TKNMWYG4QWHP775OBVIKVHZ',
  ACCOUNT_MANAGER: 'CBLIWX7IZJBOXZDNVCRBXZEOOSTO3N6ILETKUXUMORRNHBV5QFKJYQEX',
  TRACKING_TOKEN: 'CCMATDIVEEIR547UREAFKER6Q6NOAVGEMHTGVE4LTUNCQ5DXMDSTTNAP',

  // vToken receipt contracts
  VXLM_TOKEN: 'CDL65RDES3MUMIEX4PNDMVTU7ZUC5OIOZK34B3HURHRUIWAURAZYSUZD',
  VUSDC_TOKEN: 'CCUZVXTBYQEEQJ3VV5IAW3254SCVB6LREEO2IJPL7L2HAAMZUASXHZ5C',
  VBLEND_USDC_TOKEN: 'CCUZVXTBYQEEQJ3VV5IAW3254SCVB6LREEO2IJPL7L2HAAMZUASXHZ5C',
  VAQUARIUS_USDC_TOKEN: 'CBHHJX2WGLFSYEINBCYOQFFM25TUPG6GUB6EYNZBKPBRKYQCW7NY6U57',
  VSOROSWAP_USDC_TOKEN: 'CCEXBPF3AVMO5VW6E32UEDLCYZR5IXQFH3CXODNRM7JDWYDUWS4V577C',

  // Lending Pools
  LENDING_PROTOCOL_XLM: 'CDSUCPOAHZVB2PVWLXJ3ULBCCJ6QFQSESXTOAUZX6ZUELWAPC5DNC6RS',
  LENDING_PROTOCOL_USDC: 'CAK3P6O7NMWGUKKIWHEHFM2VHV5M3FMTNK6VE6GQV37B7DGQ22FSRIWR',
  LENDING_PROTOCOL_BLEND_USDC: 'CAK3P6O7NMWGUKKIWHEHFM2VHV5M3FMTNK6VE6GQV37B7DGQ22FSRIWR',
  LENDING_PROTOCOL_AQUARIUS_USDC: 'CARTPMAXNSCPMD2SJQPGDD5YLPJ7TSKBIKRVOTKTI6R72BSSM3L4TNHP',
  LENDING_PROTOCOL_SOROSWAP_USDC: 'CAKF67ZBF5QHANA2DKRX5FHWBDHSZQXXQAB3YK7ISDIN3Y4WFXW5HFM5',
