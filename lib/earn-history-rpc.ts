...
const POOLS: { contract: string; asset: string }[] = [
  ...
  { contract: CONTRACT_ADDRESSES.LENDING_PROTOCOL_BLND, asset: 'BLND' },
  { contract: CONTRACT_ADDRESSES.LENDING_PROTOCOL_AQUA, asset: 'AQUA' },
  { contract: CONTRACT_ADDRESSES.LENDING_PROTOCOL_WETH, asset: 'WETH' },
  { contract: CONTRACT_ADDRESSES.LENDING_PROTOCOL_EURC, asset: 'EURC' },
];
