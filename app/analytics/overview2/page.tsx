...
const SIM_CARDS: { cat: string; catColor: string; title: string; desc: string; route: string; lastResult: string; icon: React.ReactNode }[] = [
  ...
  { cat: "MARKET RISK", catColor: "#703AE6", title: "Stablecoin Depeg Simulation", desc: "Circle USDC depeg — dual impact: collateral value drops and borrower debt exposure changes.", route: "/analytics/risk-explorer/stablecoin-depeg", lastResult: "23 positions at risk · $1.2M bad debt est.",
